...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/customers/addNew").permitAll()
                .antMatchers("/customers","/employees","/accounts","/requestAccountCustomer","/credit","/requestCreditCustomer").hasAnyAuthority("ADMIN")
